              ...
              <div class="card">
                ...
                <?php
                        ...
                        if ($foto == 'avatar-padrao.png') {
                            ...
                            echo '<img src="../img/avatar_p/' . $foto . '" alt="' . $foto . '" title="' . $foto . '" style="width: 200px; border-radius: 100%; margin-top: 30px">';
                        } else {
                            // Exibe a imagem do usuário
                            echo '<img src="../img/cont/' . $foto . '" alt="' . $foto . '" title="' . $foto . '" style="width: 200px; border-radius: 100%; margin-top: 30px">';
                        }
                        ?>  
